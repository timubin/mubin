...
<footer class="text-center lg:text-left bg-gray-900 text-white">
  <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    ...
    <div class="flex justify-center">
      <a href="https://www.facebook.com/Tarikulislammubin" class="mr-6 text-gray-100">
      ...
      <a href="https://mailto:mubin3242@gmail.com" class="mr-6 text-gray-100">
      ...
      <a href="https://www.instagram.com/Tarikulislammubin" class="mr-6 text-gray-100">
      ...
      <a href="https://www.linkedin.com/in/tarikul-islam-mubin" class="mr-6 text-gray-100">
      ...
      <a href="https://github.com/timubin" class="text-gray-100">
...
and performance.</p>
      ...
      <div class="text-white">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-100">Angular</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-100">React</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-100">Vue</a>
        </p>
        <p>
          <a href="#!" class="text-gray-100">Laravel</a>
        </p>
      </div>
      <div class="">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div class="text-center p-6 bg-gray-800">
    <span>© 2022 Copyright | Tarikul Islam Mubin</span>
  </div>
</footer>
